...
namespace igl
{
  ...
  IGL_INLINE void shortest_edge_and_midpoint(
    ...
    double & cost,
    Eigen::RowVectorXd & p);
  IGL_INLINE void quadric_error(const int e, const Eigen::MatrixXd& V, const Eigen::MatrixXi&, const Eigen::MatrixXi& E, const Eigen::VectorXi&, const Eigen::MatrixXi&, const Eigen::MatrixXi&, double& cost, Eigen::RowVectorXd& p, std::vector<Eigen::Matrix4d> Q4);
}
